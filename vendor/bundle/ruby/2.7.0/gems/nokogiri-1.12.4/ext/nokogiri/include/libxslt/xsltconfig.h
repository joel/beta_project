...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/src/vendor/bundle/ruby/2.7.0/gems/nokogiri-1.12.4/ports/aarch64-unknown-linux-gnu/libxslt/1.1.34/lib/libxslt-plugins"
#endif
